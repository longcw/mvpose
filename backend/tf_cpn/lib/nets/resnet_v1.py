    ...
    with variable_scope.variable_scope(scope, 'bottleneck_v1', [inputs]) as sc:
        ...
        if depth == depth_in:
            ...
            shortcut = layers.conv2d(
                inputs, depth, [1, 1], stride=stride, activation_fn=None, scope='shortcut'
            )
    ...
    with variable_scope.variable_scope(scope, 'resnet_v1', [inputs], reuse=reuse) as sc:
        ...
        with arg_scope(
            ...
            if num_classes is not None:
                net = layers.conv2d(
                    net, num_classes, [1, 1], activation_fn=None, normalizer_fn=None, scope='logits'
                )
...
def resnet_v1_50(
    inputs, num_classes=None, global_pool=True, output_stride=None, reuse=None, scope='resnet_v1_50'
):
...
def resnet_v1_101(
    inputs, num_classes=None, global_pool=True, output_stride=None, reuse=None, scope='resnet_v1_101'
):
...
def resnet_v1_152(
    inputs, num_classes=None, global_pool=True, output_stride=None, reuse=None, scope='resnet_v1_152'
):
...
def resnet_v1_200(
    inputs, num_classes=None, global_pool=True, output_stride=None, reuse=None, scope='resnet_v1_200'
):
